...
public class City  implements Comparable<City>{
    ...
    private Goverment goverment;//Поле может быть null
    private StandartOfLiving standartOfLiving;//Поле может быть null
     ...
     * @param governor мэр
     */
    public City(Integer id, String name, Coordinates coordinates, java.util.Date creationDate, long area, Long population, Long metersAboveSeaLevel, long telephoneCode, Goverment goverment, StandartOfLiving standartOfLiving, Human governor){
        this.id = id;
        this.name=name;
